...
public class SavingsCalculator {
    ...
    public static void main(String[] args){
        ...
        for(int i=0; i<credits.length; ++i) credits[i] = Utilities.getFloatValue(creditsAsString[i]);
        for (int i=0; i<debits.length; ++i) debits[i] = Utilities.getFloatValue(debitsAsString[i]);
